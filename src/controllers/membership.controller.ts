...
export const handleMembershipGet = (req: Request, res: Response, pool: Pool) => {
...
export const handleMembershipPost = (req: Request, res: Response, pool: Pool) => {
...
export const handleMembershipPut = async (req: Request, res: Response, pool: Pool) => {
  const { membership, member } = req.body
